...
class SecureStorageService {
  ...
  static const String _keyTeacher = 'teacher_data';
  ...
  Future<void> saveTeacherData(Map<String, dynamic> teacherData) async {
    final jsonStr = json.encode(teacherData);
    await _storage.write(key: _keyTeacher, value: jsonStr);
  }

  Future<Map<String, dynamic>?> getTeacherData() async {
    final jsonStr = await _storage.read(key: _keyTeacher);
  ...
  Future<void> clearAuth() async {
    ...
    await _storage.delete(key: _keyTeacher);
  }
