class ApiEndpoints {
  ...
  static String get createOrder => '$baseUrl/fees/create-order';
  static String get verifyPayment => '$baseUrl/fees/verify-payment';
  static String get paymentHistory => '$baseUrl/fees/history';
