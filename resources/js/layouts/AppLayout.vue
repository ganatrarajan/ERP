            ...
            <nav class="flex-1 px-4 py-4 space-y-3 overflow-y-auto">
                ...
                <div v-if="showAdminGroup" class="space-y-1">
                    ...
                    <div v-show="expandedSections.admin" class="space-y-1 pl-1 border-l border-slate-150 dark:border-slate-800/80 ml-2">
                        ...
                        <router-link 
                            ...
                            class="flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm font-medium transition-colors"
                            :class="[isRouteActive('/super-admin/system-settings') ? 'bg-indigo-600 text-white shadow-lg shadow-indigo-600/10' : 'text-slate-655 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800/50 hover:text-slate-900 dark:hover:text-slate-200']"
                        >
                ...
                <div v-if="showAcademicsGroup" class="space-y-1">
                    ...
                    >
                        ...
                        <router-link 
                            v-if="authStore.user?.school_id && authStore.hasPermission('user.view')" 
                            to="/assignments" 
                            class="flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm font-medium transition-colors"
                            :class="[isRouteActive('/assignments') ? 'bg-indigo-600 text-white shadow-lg shadow-indigo-600/10' : 'text-slate-655 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800/50 hover:text-slate-900 dark:hover:text-slate-200']"
                        >
