        ...
        <div class="page">
            ...
            <div class="report-title-banner">
                @if (isset($rc['exam2']) && $rc['exam2'])
                    Consolidated Progress Report<br>
                ...
                @if (isset($rc['exam2']) && $rc['exam2'])
                    <thead>
                        <tr>
                            ...
                            <th class="text-center" style="width: 17%;">{{ $rc['exam']->name }}<br><span style="font-size: 8px; font-weight: normal;">Obt/Max</span></th>
                            <th class="text-center" style="width: 17%;">{{ $rc['exam2']->name }}<br><span style="font-size: 8px; font-weight: normal;">Obt/Max</span></th>
                            <th class="text-center" style="width: 18%;">Combined Total<br><span style="font-size: 8px; font-weight: normal;">Obt/Max</span></th>
                            <th class="text-center" style="width: 18%;">Combined Grade</th>
                        </tr>
                    </thead>
                    <tbody>
                ...
                @else
                    <thead>
                        <tr>
                            ...
                            <th class="text-center" style="width: 15%;">Passing Marks</th>
            ...
            @if (count($rc['co_scholastic_subjects']) > 0)
                ...
                <table class="marks-table">
                    <thead>
                        <tr>
                            <th style="width: 50%; text-align: left; padding-left: 10px;">Activity / Subject</th>
                    ...
                    <tbody>
                        @foreach ($rc['co_scholastic_subjects'] as $subj)
                            <tr>
                                <td style="padding-left: 10px;"><strong>{{ $subj['subject_name'] }}</strong></td>
                                <td class="text-center"><strong>{{ $subj['grade'] }}</strong></td>
                                <td>{{ $subj['remarks'] ?: '-' }}</td>
                            </tr>
                        @endforeach
