...
<div class="header">
    ...
    <div class="header-meta">
        <table>
            <tr>
                <td><strong>Staff Name:</strong> {{ $staff->name }}</td>
                <td><strong>Email:</strong> {{ $staff->email }}</td>
            </tr>
            <tr>
                <td><strong>Academic Year:</strong> {{ $academic_year }}</td>
                <td style="text-align: right; font-weight: bold;">STAFF ATTENDANCE REPORT</td>
            </tr>
        </table>
    </div>
</div>
...
<table class="attendance-table">
    ...
    <tbody>
        ...
        @empty
            <tr>
                <td colspan="3" style="text-align: center; color: #999; padding: 20px;">No attendance logs found.</td>
            </tr>
        @endforelse
    </tbody>
</table>
